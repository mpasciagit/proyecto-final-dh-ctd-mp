...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1️⃣ Si no hay token o no empieza con "Bearer " -> seguir sin autenticar
        ...
        jwt = authHeader.substring(7); // después de "Bearer "
        userEmail = jwtService.extractUsername(jwt); // del token saco el email/username

        // 3️⃣ Validar y setear autenticación si el usuario no está logueado ya
